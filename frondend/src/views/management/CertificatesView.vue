          ...
          <tr v-for="c in filtered" :key="c.id">
            ...
            <td>
              <div style="display:flex;gap:4px">
                ...
                <AppButton size="sm" variant="danger" @click="confirmDel(c)"><i class="ti ti-trash"></i> Delete</AppButton>
                <AppBadge v-if="isAutoLeaf(c.type)" color="purple">Auto</AppBadge>
              </div>
            </td>
          </tr>
        </tbody>
...
// All 15 certificate types from README 2.3.4.2
const allCertTypes = [
  ...
  'SECC-leaf-cert', 'CP-leaf-cert',
]

// Uploadable types — exclude SECC-leaf-cert and CP-leaf-cert, which are
// auto-generated by the signing flows (README 2.3.4.2.b)
const uploadableTypes = allCertTypes.filter(t => t !== 'SECC-leaf-cert' && t !== 'CP-leaf-cert')
...
function isAutoLeaf(t) { return t === 'SECC-leaf-cert' || t === 'CP-leaf-cert' }

function typeColor(t) {
  if (!t) return 'gray'
  if (t === 'SECC-leaf-cert' || t === 'CP-leaf-cert') return 'purple'
